...
```
تعهدات = بدهی فعلی تأمین‌کننده‌ها + مانده قابل پرداخت کل پرسنل
مانده بعد از تعهدات = مانده نقدی − تعهدات
```

> **توجه:** بدهی تأمین‌کننده و مانده حقوق پرسنل جداگانه نشان داده می‌شوند چون هنوز پرداخت نشده‌اند و نباید در cash_out پرداخت‌شده حساب شوند.
